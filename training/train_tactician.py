"""
Train: Tactician (Qwen2.5-3B).
Задача: выбрать действие монстра в бою на основе behavior_tag и HP.
3B модель — потому что план должен быть с мини-CoT.
"""
...
args = TrainingArguments(
    ...
    num_train_epochs=3, warmup_steps=20,
    learning_rate=1e-4,
